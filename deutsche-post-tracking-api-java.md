Deutsche Post Tracking API - Java
================================
Use Java to track Deutsche Post shipments with Deutsche Post Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.deutschepost;
    ...
    public class CreateDeutschePostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("LY537008690DE");
                createTrackingParams.setCourierCode("deutsche-post");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateDeutschePostTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("LD571173847BE");
                createTrackingParams1.setCourierCode("deutsche-post");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("RJ135412225DE");
                createTrackingParams2.setCourierCode("deutsche-post");
...
Get status of the shipment:
    ...
    public class GetDeutschePostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("LD571173847BE,RJ135412225DE");
                trackingParams.setCourierCode("deutsche-post");
...
Update a tracking by ID:
    ...
    public class UpdateDeutschePostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9c002905443a886bcf2c2b4b8a6e8afd";
