Deutsche Post Tracking API - .Net
================================
Use .Net to track Deutsche Post shipments with Deutsche Post Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "LY537008690DE";
                  createTrackingParams.courierCode = "deutsche-post";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  {
                      trackingNumber = "LD571173847BE",
                      courierCode = "deutsche-post"
                  };
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "LD571173847BE,RJ135412225DE";
                  getTrackingResultsParams.courierCode = "deutsche-post";
